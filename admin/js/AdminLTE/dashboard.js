...
$(function() {
    ...
    }).done(function( msg ) 
    {
      ...
      {
        r.push( {x: value.date, item1: value.attendees});
      });
    //         ,
        // r.push( {x: '2011 Q1', item1: 2666, item2: 2666});
        // r.push( {x: '2011 Q2', item1: 2778, item2: 2294});
        // r.push( {x: '2011 Q3', item1: 4912, item2: 1969});
        // r.push( {x: '2012-02-24', item1: 2666, item2: 2666});
        // r.push( {x: '2012-02-28', item1: 2778, item2: 2294});
