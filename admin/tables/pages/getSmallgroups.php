...
$grid->addColumn('sgName', 'Small Group Name', 'string', NULL, false);  
$grid->addColumn('name', 'Leader', 'string', NULL, false);  
...
$result = $mysqli->query('SELECT small_groups.sg_name AS sgName, users.fullname AS name 
  FROM small_groups JOIN users
  ON (small_groups.sg_leader_uid = users.uid)
  ORDER BY sgName');
