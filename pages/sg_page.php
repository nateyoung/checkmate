<div data-role="page" id="sg_page">
  <div data-role="header" data-add-back-btn="true" data-theme="b">
    <a href="#left_menu6" class="ui-btn-left" data-icon="grid" data-iconpos="notext">Menu</a>
    <h1>Students</h1>
  </div>
  <div role="main" class="ui-content">
    ...
    <div class="student-iframe-wrapper">
      <iframe src="admin/tables/smallgroups.html"></iframe>
    </div>
    <?php
    }
    ?>
  ...
  <!-- menu panel -->
  <div data-role="panel" id="left_menu6" data-position="left" data-display="overlay" >
